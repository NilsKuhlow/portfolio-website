...
const Home = ({ onOpen, setRoute, lang }) => {
  ...
  const NEWS_DE = [
    { tag: 'Stegreif',         title: 'ZU WASSER LASSEN — REGATTA IN WENDORF',          body: 'Ein schwimmfähiges Boot aus Karton und Pappmaché, vom 1:20-Modell bis zum 1:1-Bau und am Strand von Wendorf zu Wasser gelassen.', img: 'assets/projects/zu-wasser-lassen/card-wide.jpg', shape: 'wide' },
    { tag: 'Installation 1:1', title: 'RANDSTADT — FOLIENTUNNEL IM SCHNEE',             body: 'Ein Folientunnel verdichtet einen Weg in der Randstadt von Wismar: von der Weite in die Enge und zurück ins Freie.', img: 'assets/projects/randstadt-intervention/card-wide.jpg', shape: 'pano' },
    ...
    { tag: 'Entwurf',          title: 'RAUM – STRUKTUR – HÜLLE — ÜBER DEM PLATTENBAU',   body: 'Eine leichte, parasitäre Struktur legt sich über ein Plattenbau-Ensemble und verbindet die Dächer zu einer gemeinschaftlichen Fläche.', img: 'assets/projects/raum-struktur-huelle/card-wide.jpg', shape: 'wide' },
  ...
  const NEWS_EN = [
    { tag: 'Workshop',         title: 'SET AFLOAT — REGATTA AT WENDORF',                body: 'A buoyant boat of cardboard and papier-mâché, from a 1:20 model to a full-size build and launched on the beach at Wendorf.', img: 'assets/projects/zu-wasser-lassen/card-wide.jpg', shape: 'wide' },
        ...
        <div className="nk-stack" style={grid}>
          ...
          <div style={captionWrap}>
            ...
            <div style={ctrlRow}>
              ...
              <div style={dotsRow}>
                {FEATURED.map((_, k) => (
                  <button key={k} type="button" style={dotBtn} onClick={() => setI(k)} aria-current={k === i ? 'true' : undefined} aria-label={(lang === 'de' ? 'Projekt ' : 'Project ') + (k + 1)}>
                    <span style={dotBar(k === i)} />
                  </button>
                ))}
              </div>
