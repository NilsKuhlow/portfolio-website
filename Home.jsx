...
const Home = ({ onOpen, setRoute, lang }) => {
  ...
  const NEWS_DE = [
    { tag: 'Stegreif',         title: 'ZU WASSER LASSEN — REGATTA IN WENDORF',          body: 'Ein schwimmfähiges Boot aus Karton und Pappmaché, vom 1:20-Modell bis zum 1:1-Bau — und am Strand von Wendorf zu Wasser gelassen.', img: 'assets/projects/zu-wasser-lassen/card.jpg', shape: 'pano' },
    { tag: 'Installation 1:1', title: 'RANDSTADT — FOLIENTUNNEL IM SCHNEE',             body: 'Ein Folientunnel verdichtet einen Weg in der Randstadt von Wismar: von der Weite in die Enge und zurück ins Freie.', img: 'assets/projects/randstadt-intervention/hero.jpg', shape: 'wide' },
    { tag: 'Guss',             title: 'MASSE UND HOHLRAUM — BETONGUSS IN ERDE',          body: 'Negativräume in Wachs und Beton gegossen, im Verfahren des Glockengusses. Sichtbar bleibt nur der Hohlraum, belichtet über ein Oberlicht.', img: 'assets/projects/masse-und-hohlraum/hero.jpg', shape: 'square' },
    { tag: 'Raumstudie',       title: 'GENIUS LOCI — INNENRÄUME DER STADT',             body: 'Straßen und Plätze als Innenräume der Stadt, gefasst durch Fassaden, Licht und Bewegung — im Abendlicht fotografiert.', img: 'assets/projects/genius-loci/card.jpg', shape: 'tall' },
    { tag: 'Entwurf',          title: 'RAUM – STRUKTUR – HÜLLE — ÜBER DEM PLATTENBAU',   body: 'Eine leichte, parasitäre Struktur legt sich über ein Plattenbau-Ensemble und verbindet die Dächer zu einer gemeinschaftlichen Fläche.', img: 'assets/projects/raum-struktur-huelle/card.jpg', shape: 'wide' },
  ...
  const NEWS_EN = [
    { tag: 'Workshop',         title: 'SET AFLOAT — REGATTA AT WENDORF',                body: 'A buoyant boat of cardboard and papier-mâché, from a 1:20 model to a full-size build — and launched on the beach at Wendorf.', img: 'assets/projects/zu-wasser-lassen/card.jpg', shape: 'pano' },
    ...
    { tag: 'Spatial study',    title: 'GENIUS LOCI — INTERIORS OF THE CITY',            body: 'Streets and squares as interiors of the city, held by façades, light and movement — photographed in evening light.', img: 'assets/projects/genius-loci/card.jpg', shape: 'tall' },
