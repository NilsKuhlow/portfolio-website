...
// Terse program label for the (now inert) data-sec anchors. Inlined here after the
// per-project SectionRail was removed, so this file no longer depends on its global.
function shortSec(s) {
  if (!s) return '';
