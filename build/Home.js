...
const Home = ({ onOpen, setRoute, lang }) => {
  ...
  const NEWS_DE = [
    ...
    { tag: "Raumstudie", title: "GENIUS LOCI \u2014 INNENR\xC4UME DER STADT", body: "Stra\xDFen und Pl\xE4tze als Innenr\xE4ume der Stadt, gefasst durch Fassaden, Licht und Bewegung \u2014 im Abendlicht fotografiert.", img: "assets/projects/genius-loci/card.jpg", shape: "tall" },
  ...
  const NEWS_EN = [
    ...
    { tag: "Spatial study", title: "GENIUS LOCI \u2014 INTERIORS OF THE CITY", body: "Streets and squares as interiors of the city, held by fa\xE7ades, light and movement \u2014 photographed in evening light.", img: "assets/projects/genius-loci/card.jpg", shape: "tall" },
