...
const Home = ({ onOpen, setRoute, lang }) => {
  ...
  const NEWS_DE = [
    { tag: "Stegreif", title: "ZU WASSER LASSEN \u2014 REGATTA IN WENDORF", body: "Ein schwimmf\xE4higes Boot aus Karton und Pappmach\xE9, vom 1:20-Modell bis zum 1:1-Bau \u2014 und am Strand von Wendorf zu Wasser gelassen.", img: "assets/projects/zu-wasser-lassen/hero.jpg", shape: "wide" },
    { tag: "Installation 1:1", title: "RANDSTADT \u2014 FOLIENTUNNEL IM SCHNEE", body: "Ein Folientunnel verdichtet einen Weg in der Randstadt von Wismar: von der Weite in die Enge und zur\xFCck ins Freie.", img: "assets/projects/randstadt-intervention/hero.jpg", shape: "pano" },
    ...
    { tag: "Entwurf", title: "RAUM \u2013 STRUKTUR \u2013 H\xDCLLE \u2014 \xDCBER DEM PLATTENBAU", body: "Eine leichte, parasit\xE4re Struktur legt sich \xFCber ein Plattenbau-Ensemble und verbindet die D\xE4cher zu einer gemeinschaftlichen Fl\xE4che.", img: "assets/projects/raum-struktur-huelle/hero.jpg", shape: "wide" },
  ...
  const NEWS_EN = [
    { tag: "Workshop", title: "SET AFLOAT \u2014 REGATTA AT WENDORF", body: "A buoyant boat of cardboard and papier-m\xE2ch\xE9, from a 1:20 model to a full-size build \u2014 and launched on the beach at Wendorf.", img: "assets/projects/zu-wasser-lassen/hero.jpg", shape: "wide" },
