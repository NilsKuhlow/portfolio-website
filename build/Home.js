...
const Home = ({ onOpen, setRoute, lang }) => {
  ...
  const NEWS_DE = [
    { tag: "Stegreif", title: "ZU WASSER LASSEN \u2014 REGATTA IN WENDORF", body: "Ein schwimmf\xE4higes Boot aus Karton und Pappmach\xE9, vom 1:20-Modell bis zum 1:1-Bau \u2014 und am Strand von Wendorf zu Wasser gelassen.", img: "assets/projects/zu-wasser-lassen/card.jpg", shape: "pano" },
    { tag: "Installation 1:1", title: "RANDSTADT \u2014 FOLIENTUNNEL IM SCHNEE", body: "Ein Folientunnel verdichtet einen Weg in der Randstadt von Wismar: von der Weite in die Enge und zur\xFCck ins Freie.", img: "assets/projects/randstadt-intervention/hero.jpg", shape: "wide" },
    { tag: "Guss", title: "MASSE UND HOHLRAUM \u2014 BETONGUSS IN ERDE", body: "Negativr\xE4ume in Wachs und Beton gegossen, im Verfahren des Glockengusses. Sichtbar bleibt nur der Hohlraum, belichtet \xFCber ein Oberlicht.", img: "assets/projects/masse-und-hohlraum/hero.jpg", shape: "square" },
    { tag: "Raumstudie", title: "GENIUS LOCI \u2014 INNENR\xC4UME DER STADT", body: "Stra\xDFen und Pl\xE4tze als Innenr\xE4ume der Stadt, gefasst durch Fassaden, Licht und Bewegung \u2014 der K\xF6rper als r\xE4umliches Ma\xDF.", img: "assets/projects/genius-loci/card.jpg", shape: "tall" },
    { tag: "Entwurf", title: "RAUM \u2013 STRUKTUR \u2013 H\xDCLLE \u2014 \xDCBER DEM PLATTENBAU", body: "Eine leichte, parasit\xE4re Struktur legt sich \xFCber ein Plattenbau-Ensemble und verbindet die D\xE4cher zu einer gemeinschaftlichen Fl\xE4che.", img: "assets/projects/raum-struktur-huelle/card.jpg", shape: "wide" },
  ...
  const NEWS_EN = [
    { tag: "Workshop", title: "SET AFLOAT \u2014 REGATTA AT WENDORF", body: "A buoyant boat of cardboard and papier-m\xE2ch\xE9, from a 1:20 model to a full-size build \u2014 and launched on the beach at Wendorf.", img: "assets/projects/zu-wasser-lassen/card.jpg", shape: "pano" },
    { tag: "Installation 1:1", title: "EDGE-CITY \u2014 A FOIL TUNNEL IN SNOW", body: "A foil tunnel condenses a path on the edge of Wismar: from openness into compression and back into the open.", img: "assets/projects/randstadt-intervention/hero.jpg", shape: "wide" },
    { tag: "Casting", title: "MASS AND VOID \u2014 CONCRETE CAST IN EARTH", body: "Voids cast in wax and concrete, after the technique of bell-casting. Only the hollow space remains, lit through a skylight.", img: "assets/projects/masse-und-hohlraum/hero.jpg", shape: "square" },
    { tag: "Spatial study", title: "GENIUS LOCI \u2014 INTERIORS OF THE CITY", body: "Streets and squares as interiors of the city, held by fa\xE7ades, light and movement \u2014 the body as a spatial measure.", img: "assets/projects/genius-loci/card.jpg", shape: "tall" },
    { tag: "Design", title: "SPACE \u2013 STRUCTURE \u2013 SKIN \u2014 OVER THE PREFAB", body: "A light, parasitic structure laid over a prefab housing ensemble, joining the roofs into a shared surface.", img: "assets/projects/raum-struktur-huelle/card.jpg", shape: "wide" },
