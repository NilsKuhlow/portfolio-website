const ProjectDetail = ({ p, onClose, onOpen, lang }) => {
  ...
  const liveLink = p.liveUrl ? /* @__PURE__ */ React.createElement("a", { href: p.liveUrl, target: "_blank", rel: "noopener noreferrer", className: "nk-link", style: liveBtn }, lang === "de" ? "Website live \xF6ffnen \u2197" : "Open the live site \u2197") : null;
  const embedEl = p.embed && p.liveUrl ? /* @__PURE__ */ React.createElement("div", { className: "nk-pad", style: { maxWidth: 1440, margin: "0 auto", padding: "96px 40px 0" } }, /* @__PURE__ */ React.createElement("div", { style: { ...procH, marginTop: 0 } }, lang === "de" ? "Live ausprobieren" : "Try it live"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "center" } }, /* @__PURE__ */ React.createElement(
    "iframe",
    {
      src: p.liveUrl,
      title: L(p.t, lang),
  ...
  if (p.gallery && p.galleryDark) {
    imageSection = /* @__PURE__ */ React.createElement("div", { className: "nk-band-dark nk-bleed", style: { marginTop: 96 } }, /* @__PURE__ */ React.createElement("div", { style: { ...padWrap, padding: "76px 40px" } }, galleryGrid, capRow(true)));
  } else if (p.gallery) {
    imageSection = /* @__PURE__ */ React.createElement("div", { className: "nk-pad", style: stripWrap }, galleryGrid, capRow(false));
  } else {
    imageSection = /* @__PURE__ */ React.createElement("div", { className: "nk-pad", style: stripWrap }, /* @__PURE__ */ React.createElement("div", { className: "nk-stack", style: stripGrid }, /* @__PURE__ */ React.createElement("div", { style: halfImg(p.stripA || "assets/photo-placeholder-cool.svg"), role: "img", "aria-label": L(p.t, lang) }), /* @__PURE__ */ React.createElement("div", { style: halfImg(p.stripB || "assets/photo-placeholder-stone.svg"), role: "img", "aria-label": L(p.t, lang) })), capRow(false));
  }
  return /* @__PURE__ */ React.createElement("article", { "data-screen-label": "05 Project Detail" }, /* @__PURE__ */ React.createElement("div", { className: "nk-pad", style: topWrap }, /* @__PURE__ */ React.createElement("button", { type: "button", className: "nk-link", style: back, onClick: onClose }, t.back), /* @__PURE__ */ React.createElement("div", { className: "nk-stack", style: head }, /* @__PURE__ */ React.createElement("aside", null, /* @__PURE__ */ React.createElement("div", { style: lblK }, t.project), /* @__PURE__ */ React.createElement("div", { style: lblV }, String(idx + 1).padStart(2, "0"), " / ", String(PROJECTS.length).padStart(2, "0")), /* @__PURE__ */ React.createElement("div", { style: lblK }, t.location), /* @__PURE__ */ React.createElement("div", { style: lblV }, L(p.location, lang)), /* @__PURE__ */ React.createElement("div", { style: lblK }, t.date), /* @__PURE__ */ React.createElement("div", { style: lblV }, p.year), /* @__PURE__ */ React.createElement("div", { style: lblK }, t.semester), /* @__PURE__ */ React.createElement("div", { style: lblV }, L(p.semester, lang)), /* @__PURE__ */ React.createElement("div", { style: lblK }, t.typology), /* @__PURE__ */ React.createElement("div", { style: lblV }, L(p.tag, lang)), /* @__PURE__ */ React.createElement("div", { style: lblK }, t.status), /* @__PURE__ */ React.createElement("div", { style: lblV }, L(p.status, lang)), /* @__PURE__ */ React.createElement("div", { style: lblK }, t.role), /* @__PURE__ */ React.createElement("div", { style: lblV }, L(p.role, lang))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { style: eyebrow }, L(p.kicker, lang)), /* @__PURE__ */ React.createElement("h1", { style: big }, L(p.t, lang)), /* @__PURE__ */ React.createElement("p", { style: lede }, L(p.summary, lang)), liveLink))), heroEl, /* @__PURE__ */ React.createElement("div", { className: "nk-pad", style: padWrap }, /* @__PURE__ */ React.createElement("div", { className: "nk-stack", style: body }, /* @__PURE__ */ React.createElement("div", null), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { style: para }, p.bodyP1 ? L(p.bodyP1, lang) : t.bodyP1), /* @__PURE__ */ React.createElement("p", { style: para }, p.bodyP2 ? L(p.bodyP2, lang) : t.bodyP2), /* @__PURE__ */ React.createElement("blockquote", { style: q }, p.pull ? L(p.pull, lang) : t.pull), /* @__PURE__ */ React.createElement("div", { style: procH }, t.process), /* @__PURE__ */ React.createElement("ul", { style: procList }, L(p.process, lang).map((step, i) => /* @__PURE__ */ React.createElement("li", { key: i, style: procLi }, /* @__PURE__ */ React.createElement("span", { style: procDot }, "P/", String(i + 1).padStart(2, "0")), /* @__PURE__ */ React.createElement("span", null, step))))))), embedEl, imageSection, /* @__PURE__ */ React.createElement("div", { className: "nk-stack", style: navWrap }, /* @__PURE__ */ React.createElement("div", { className: "nk-card", style: navCard, role: "button", tabIndex: 0, onClick: () => onOpen(prev), onKeyDown: (e) => {
