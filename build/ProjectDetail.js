const ProjectDetail = ({ p, onClose, onOpen, lang }) => {
  ...
  const articleEl = p.article ? /* @__PURE__ */ React.createElement("div", { className: "nk-pad", style: { maxWidth: 1080, margin: "0 auto", padding: "8px 40px 0" } }, p.article.map((b, i) => {
    if (b.h) return /* @__PURE__ */ React.createElement("h2", { key: i, style: aH }, L(b.h, lang));
