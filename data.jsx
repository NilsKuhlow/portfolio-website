...
const PROJECTS = [
  ...
  },
  {
    ...
    article: [
      ...
      { p: { de: 'Hamburg ist historisch eng mit dem Hafen verbunden, der über Jahrhunderte das wirtschaftliche Rückgrat der Stadt bildete und ihre räumliche Struktur prägte. Die innerstädtischen Hafenbereiche waren bis ins frühe 20. Jahrhundert funktional organisiert und dienten mit Speicherbauten, Kais und Hafenbecken primär dem Warenumschlag, getrennt vom alltäglichen städtischen Leben.', en: 'Hamburg is historically bound to its harbour, which for centuries formed the economic backbone of the city and shaped its spatial structure. Into the early twentieth century the inner-city port areas were functionally organised and served, with warehouses, quays and basins, primarily the handling of goods, kept apart from everyday urban life.' } },
      { p: { de: 'Mit der Einführung der Containerlogistik in der zweiten Hälfte des 20. Jahrhunderts verlagerte sich der Hafenbetrieb stromabwärts. Die innenstadtnahen Hafenflächen verloren ihre Funktion und wurden zu zentral gelegenen, infrastrukturell geprägten Brachen, dem Ausgangspunkt einer postindustriellen Stadtentwicklung.', en: 'With the arrival of container logistics in the second half of the twentieth century, port operations moved downstream. The harbour areas near the city centre lost their function and became centrally located, infrastructurally marked wastelands, the starting point of a post-industrial urban development.' } },
      { img: 'assets/projects/edge-hafencity/g6.jpg', r: '3/2', cap: { de: 'Der Hamburger Hafen um 1888, das wirtschaftliche Rückgrat der Stadt.', en: 'The Port of Hamburg around 1888, the economic backbone of the city.' } },
      { h: { de: 'Die HafenCity als städtebauliches Großprojekt', en: 'The HafenCity as an urban megaproject' } },
      { p: { de: 'Die HafenCity Hamburg ist eines der größten innerstädtischen Stadtentwicklungsprojekte Europas und entstand vor dem Hintergrund des strukturellen Wandels des Hamburger Hafens. Mit der Verlagerung des Hafenbetriebs stromabwärts verloren große, innenstadtnahe Hafenflächen ihre ursprüngliche Funktion und bildeten die Grundlage für die Entwicklung eines neuen urbanen Stadtteils.', en: 'The HafenCity Hamburg is one of Europe\'s largest inner-city development projects and arose against the backdrop of the structural change of the Port of Hamburg. As port operations moved downstream, large harbour areas near the centre lost their original function and became the basis for the development of a new urban district.' } },
      { p: { de: 'Ziel der HafenCity ist nicht die Entwicklung eines isolierten Quartiers, sondern die strukturelle Erweiterung der Hamburger Innenstadt. Arbeiten, Wohnen, Kultur, Bildung und Freizeit sollen bewusst miteinander kombiniert werden, um eine dauerhafte Nutzung über den Tagesverlauf hinweg zu ermöglichen. Nutzungsmischung und urbane Dichte bilden dabei zentrale Leitmotive.', en: 'The aim of the HafenCity is not an isolated quarter but the structural extension of Hamburg\'s inner city. Work, living, culture, education and leisure are deliberately combined to allow a lasting use across the course of the day. A mix of uses and urban density are the central leitmotifs.' } },
      { p: { de: 'Die Entwicklung erfolgt auf Grundlage eines übergeordneten Masterplans, der Baufluchten, Gebäudehöhen, Nutzungsverteilungen und Freiraumstrukturen festlegt. Dieser steuernde Ansatz sorgt für städtebauliche Ordnung, schränkt jedoch den gestalterischen Spielraum einzelner Projekte ein. Architektur wird weniger als individuelles Statement verstanden, sondern als Teil eines funktionierenden Gesamtsystems.', en: 'Development follows an overarching masterplan that fixes building lines, heights, the distribution of uses and the structure of open space. This steering approach creates urban order, yet it limits the design freedom of individual projects. Architecture is understood less as an individual statement than as part of a functioning whole.' } },
      { p: { de: 'Ein prägendes Merkmal der HafenCity ist der Umgang mit dem Hochwasserschutz. Anstelle klassischer Deichanlagen wird das Warften-Prinzip angewendet: Gebäude stehen auf erhöhten Sockelzonen, während Straßen und Plätze im Hochwasserfall kontrolliert überflutet werden können. Hochwasserschutz wird damit integraler Bestandteil des Städtebaus.', en: 'A defining feature of the HafenCity is its handling of flood protection. Instead of classic dikes it applies the Warften principle: buildings stand on raised plinths, while streets and squares can be flooded in a controlled way during high water. Flood protection thus becomes an integral part of the urban design.' } },
      { p: { de: 'Trotz ihres hohen planerischen Anspruchs ist die HafenCity nicht frei von Kritik. Begrenzte soziale Durchmischung und die teilweise kontrollierte Wirkung öffentlicher Räume werden diskutiert. Die HafenCity kann als städtebauliches Labor verstanden werden, das Potenziale und Grenzen masterplangeführter Stadtentwicklung sichtbar macht.', en: 'Despite its high planning ambition, the HafenCity is not free of criticism. A limited social mix and the partly controlled character of its public spaces are subjects of debate. The HafenCity can be read as an urban laboratory that makes visible both the potentials and the limits of masterplan-led development.' } },
      { h: { de: 'EDGE HafenCity im städtebaulichen Kontext', en: 'EDGE HafenCity in its urban context' } },
      { p: { de: 'Das EDGE HafenCity ist fest in das masterplangeführte System der HafenCity eingebunden. Seine Architektur folgt klaren planerischen Vorgaben zu Baufluchten, Höhen und Sockelzonen und ist weniger als freier Entwurf denn als funktionale Reaktion auf diesen Rahmen zu verstehen.', en: 'EDGE HafenCity is firmly embedded in the masterplan-led system of the HafenCity. Its architecture follows clear planning specifications for building lines, heights and plinths and is to be understood less as a free design than as a functional response to that frame.' } },
      { img: 'assets/projects/edge-hafencity/g2.jpg', r: '3/2', cap: { de: 'EDGE HafenCity von HENN, ein gestaffelter Baukörper im Quartier.', en: 'EDGE HafenCity by HENN, a stepped volume within the block.' } },
      { p: { de: 'Der Baukörper ordnet sich in die Blockstruktur des Quartiers ein und wird durch Staffelungen gegliedert, ohne seine Großmaßstäblichkeit vollständig aufzulösen. Besonders prägend ist die erhöhte Sockelzone infolge des Warften-Prinzips, die funktional notwendig ist, jedoch Distanz zum öffentlichen Raum schafft und die Belebung des Erdgeschosses begrenzt.', en: 'The volume fits into the block structure of the quarter and is articulated through setbacks, without fully dissolving its large scale. Particularly formative is the raised plinth that follows from the Warften principle: functionally necessary, yet creating distance from the public realm and limiting the activity of the ground floor.' } },
      { p: { de: 'Insgesamt fungiert das Gebäude als ordnender Baustein innerhalb der HafenCity, bleibt jedoch in seiner stadträumlichen Wirkung zurückhaltend und wirft Fragen nach der urbanen Qualität großmaßstäblicher Bürogebäude in stark regulierten Entwicklungsprojekten auf.', en: 'Overall the building works as an ordering element within the HafenCity, yet stays reserved in its urban presence and raises questions about the urban quality of large-scale office buildings in heavily regulated development projects.' } },
      { h: { de: 'Architekten und architektonische Haltung', en: 'Architects and architectural stance' } },
      { p: { de: 'Entworfen wurde das Gebäude vom international tätigen Architekturbüro HENN, das sich auf komplexe Großprojekte, insbesondere Büro-, Forschungs- und Bildungsbauten, spezialisiert hat. Die Architektur von HENN ist rational, systemisch und stark nutzungsorientiert. Gebäude werden als funktionale Systeme verstanden, in denen Organisation, Technik und Nutzung im Vordergrund stehen. Diese Haltung zeigt sich deutlich im EDGE HafenCity. Der Baukörper ist großmaßstäblich organisiert, wird jedoch durch Staffelungen und Rücksprünge gegliedert. Formal bleibt die Architektur bewusst zurückhaltend und verzichtet auf expressive Gesten.', en: 'The building was designed by the international practice HENN, which specialises in complex large projects, in particular office, research and educational buildings. HENN\'s architecture is rational, systemic and strongly use-oriented. Buildings are understood as functional systems in which organisation, technology and use come first. This stance is clearly visible in EDGE HafenCity. The volume is organised at a large scale, yet articulated through setbacks and recesses. Formally the architecture stays deliberately reserved and avoids expressive gestures.' } },
      { h: { de: 'Fassade, Konstruktion und Nutzung', en: 'Facade, construction and use' } },
      { p: { de: 'Die Fassade ist als hochtransparente Glasfassade mit klar definiertem Raster ausgebildet. Vertikale und horizontale Profile übernehmen konstruktive, energetische und gestalterische Funktionen. Großformatige Fenster sorgen für Tageslichtversorgung und visuelle Durchlässigkeit zwischen Innenraum und Stadtraum.', en: 'The facade is built as a highly transparent glass facade with a clearly defined grid. Vertical and horizontal profiles take on structural, energetic and formal functions. Large-format windows provide daylight and a visual permeability between interior and city.' } },
      ...
      { p: { de: 'Die Tragstruktur basiert auf einem regelmäßigen Stahlbeton-Stützenraster, das flexible Grundrisse und unterschiedliche Bürotypologien ermöglicht. Zentrale Erschließungskerne bündeln Aufzüge, Treppen und Technik. Die Nutzung ist auf moderne Arbeitswelten ausgelegt und soll langfristige Anpassungsfähigkeit gewährleisten.', en: 'The load-bearing structure is based on a regular reinforced-concrete column grid that allows flexible floor plans and different office typologies. Central cores bundle lifts, stairs and services. The use is geared to modern work worlds and is meant to ensure long-term adaptability.' } },
      { img: 'assets/projects/edge-hafencity/g3.jpg', r: '4/3', cap: { de: 'Innenhof und Erschließung, ausgelegt auf moderne Arbeitswelten.', en: 'Atrium and circulation, geared to modern work worlds.' } },
      { h: { de: 'Kritische Betrachtung: Nachhaltigkeit und Greenwashing', en: 'A critical view: sustainability and greenwashing' } },
      { p: { de: 'Trotz der hohen technischen Qualität erscheint das Nachhaltigkeitsversprechen des EDGE HafenCity kritisch hinterfragbar. Das Gebäude basiert auf einem klassischen Stahlbeton-Skelettbau, dessen Herstellung mit erheblichen CO₂-Emissionen verbunden ist. Auch bei optimiertem Betrieb bleibt der ökologische Fußabdruck der Konstruktion problematisch.', en: 'Despite its high technical quality, the sustainability promise of EDGE HafenCity is open to critical question. The building rests on a classic reinforced-concrete skeleton whose production involves considerable CO₂ emissions. Even in optimised operation, the ecological footprint of the construction remains problematic.' } },
      { p: { de: 'In diesem Zusammenhang lässt sich von Greenwashing sprechen: Nachhaltigkeit wird vor allem über Kennzahlen, Zertifikate und Marketing kommuniziert, während Fragen nach Materialität, grauer Energie und Ressourcenschonung in den Hintergrund treten. Ein Betonbau kann, trotz effizienter Gebäudetechnik, nur bedingt als klimaneutral gelten.', en: 'In this context one can speak of greenwashing: sustainability is communicated above all through metrics, certificates and marketing, while questions of materiality, embodied energy and the careful use of resources recede into the background. A concrete building, despite efficient building services, can only ever be considered climate-neutral to a limited degree.' } },
      { img: 'assets/projects/edge-hafencity/g5.jpg', r: '3/2', cap: { de: 'Nachhaltigkeit, vor allem über Zertifikate und Kennzahlen kommuniziert.', en: 'Sustainability, communicated above all through certificates and metrics.' } },
      { q: { de: 'Nachhaltigkeit wird zertifiziert, nicht konstruiert.', en: 'Sustainability gets certified, not constructed.' } },
      { h: { de: 'Büroarchitektur nach Corona: ein überholtes Modell?', en: 'Office architecture after Corona: an outdated model?' } },
      { p: { de: 'Die veränderte Rolle von Bürogebäuden seit der Corona-Pandemie verschärft diese Problematik. Viele Arbeitsprozesse haben sich dauerhaft ins Homeoffice oder in hybride Modelle verlagert. Klassische Büroflächen sind weniger gefragt als noch vor wenigen Jahren. Das EDGE HafenCity steht teilweise leer, was die Frage nach der langfristigen Sinnhaftigkeit solcher Großprojekte verstärkt.', en: 'The changed role of office buildings since the Corona pandemic sharpens this problem. Many work processes have shifted permanently to home office or to hybrid models. Classic office space is less in demand than only a few years ago. EDGE HafenCity stands partly empty, which strengthens the question of the long-term sense of such large projects.' } },
      { p: { de: 'Ein Gebäude, das auf maximale Büroflächenoptimierung ausgelegt ist, wirkt in diesem Kontext aus der Zeit gefallen. Die Flexibilität der Grundrisse kann diese strukturelle Veränderung nur begrenzt auffangen. Nachhaltigkeit müsste hier auch programmatisch gedacht werden, etwa durch stärkere Nutzungsdurchmischung oder Umnutzbarkeit.', en: 'A building designed for maximum optimisation of office space appears, in this context, out of its time. The flexibility of the floor plans can absorb this structural change only to a limited extent. Sustainability would have to be thought of here programmatically as well, for instance through a stronger mix of uses or the capacity for conversion.' } },
      { h: { de: 'Fazit', en: 'Conclusion' } },
      { p: { de: 'Das EDGE HafenCity ist ein präzise geplantes, technisch hochwertiges Bürogebäude, das den städtebaulichen Vorgaben der HafenCity konsequent folgt. Es steht für eine Architektur, die innerhalb eines stark gesteuerten Systems funktioniert und funktionale Klarheit in den Vordergrund stellt. Gleichzeitig offenbart das Projekt zentrale Schwächen. Das Nachhaltigkeitsversprechen wirkt angesichts der konstruktiven Realität und der aktuellen Nutzungssituation nur bedingt überzeugend. In einer Zeit grundlegenden Wandels der Büroarbeit erscheint der großmaßstäbliche Betonbau eher als Symptom vergangener Planungslogiken, weniger als zukunftsweisendes Modell.', en: 'EDGE HafenCity is a precisely planned, technically high-quality office building that follows the urban specifications of the HafenCity with consistency. It stands for an architecture that works within a strongly steered system and puts functional clarity in the foreground. At the same time the project reveals central weaknesses. Its sustainability promise is only partly convincing in the light of the constructive reality and the current situation of use. In a time of fundamental change in office work, the large-scale concrete building appears more as a symptom of past planning logics than as a model that points to the future.' } },
      { p: { de: 'Das Gebäude zeigt, dass Umnutzbarkeit ein zentraler Aspekt zukünftiger Großprojektplanung sein sollte.', en: 'The building shows that the capacity for conversion should be a central aspect of planning future large projects.' } },
    ],
    summary: {
    ...
    capText: {
      de: 'Vom Luftbild der HafenCity über das Gebäude von HENN, seinen Innenhof und die Rasterfassade bis zu den Nachhaltigkeitszertifikaten und dem historischen Hafen. Einzelarbeit.',
...
const CV = {
  education: [
    ...
    { y: '2023–2025',
      ...
      detail: { de: 'Zweijährige Ausbildung im Holzbau, Gesellenabschluss im Juli 2025, die Grundlage meines materialnahen Zugangs zur Architektur.', en: 'Two-year training in timber construction, journeyman qualification in July 2025, the foundation of my material-led approach to architecture.' },
    },
    { y: '2015–2023',
